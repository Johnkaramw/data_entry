...
class kobrynabial extends StatefulWidget {
  const kobrynabial({super.key});

  @override
  State<kobrynabial> createState() => _kobrynabialState();
}

class _kobrynabialState extends State<kobrynabial> {
  ...
  final String _storageKey =
      'kobrynabialChildrenDetails'; // مفتاح خاص بهذه الصفحة
