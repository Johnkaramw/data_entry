...
class almnatekalaokra extends StatefulWidget {
  const almnatekalaokra({super.key});

  @override
  State<almnatekalaokra> createState() => _almnatekalaokraState();
}

class _almnatekalaokraState extends State<almnatekalaokra> {
  ...
  final String storageKey = 'almnatekalaokra_childrenDetails'; // مفتاح خاص بالصفحة
  ...
  Future<void> _saveChildrenDetails() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(storageKey, jsonEncode(_childrenDetails));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('إدارة بيانات المناطق الأخرى'),
      ),
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
