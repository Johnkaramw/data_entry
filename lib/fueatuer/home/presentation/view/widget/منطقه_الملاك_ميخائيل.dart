...
class elmalakmekael extends StatefulWidget {
  const elmalakmekael({super.key});

  @override
  State<elmalakmekael> createState() => _elmalakmekaelState();
}

class _elmalakmekaelState extends State<elmalakmekael> {
  ...
  final String _storageKey = 'elmalakmekaelChildrenDetails'; // مفتاح خاص بهذه الصفحة
