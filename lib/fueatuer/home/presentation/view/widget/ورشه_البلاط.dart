...
class warshetalbalat extends StatefulWidget {
  const warshetalbalat({super.key});

  @override
  State<warshetalbalat> createState() => _warshetalbalatState();
}

class _warshetalbalatState extends State<warshetalbalat> {
  ...
  final String _storageKey = 'warshetalbalatChildrenDetails'; // مفتاح خاص بهذه الصفحة
